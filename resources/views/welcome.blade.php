            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('service.show', ['slug' => 'construction']) }}" class="text-primary border border-primary px-4 py-2 rounded-md hover:bg-primary hover:text-white transition">Pelajari Lebih Lanjut</a>
                    </div>
                </div>
                <div class="border border-gray-200 rounded-lg p-6">
                    <div class="flex justify-center mb-4">
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('service.show', ['slug' => 'renovation']) }}" class="text-primary border border-primary px-4 py-2 rounded-md hover:bg-primary hover:text-white transition">Pelajari Lebih Lanjut</a>
                    </div>
                </div>
                <div class="border border-gray-200 rounded-lg p-6">
                    <div class="flex justify-center mb-4">
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('service.show', ['slug' => 'design']) }}" class="text-primary border border-primary px-4 py-2 rounded-md hover:bg-primary hover:text-white transition">Pelajari Lebih Lanjut</a>
                    </div>
                </div>
            </div>
        </div>
