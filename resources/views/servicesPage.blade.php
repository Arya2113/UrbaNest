...
<div class="bg-slate-50 min-h-screen">
    ...
    <div class="border border-gray-200 rounded-lg p-6 flex flex-col">
        ...
        <div class="flex justify-center mt-auto">
            <a href="#" class="text-blue-600 border border-blue-600 px-4 py-2 rounded-md hover:bg-blue-600 hover:text-white transition">Learn More</a>
        </div>
    </div>
    {{-- Card 2: Renovation --}}
    <div class="border border-gray-200 rounded-lg p-6 flex flex-col">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-emerald-700 rounded-xl flex items-center justify-center flex-shrink-0">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
